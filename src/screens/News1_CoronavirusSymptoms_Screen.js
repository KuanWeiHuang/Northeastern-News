        ...
        <View style={styles.viewStyle}>
            <ScrollView>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                    ...
                    <Text style={styles.headStyle}>{label}</Text> 
                </View>
                ...
                <Image
                    ...
                    source={require('../../assets/News1_HeadPic.png')}
                />
                <View style={{alignItems: 'flex-start', }}>
                    <Text style={{fontSize:10}}>{photoDetails}</Text>
                </View>
                <View>
                    <Text style={styles.photoAuthorStyle}>{photoAuthor}</Text>
                </View>
                <Text style={styles.paraContentStyle}>{paragraph1}</Text>
                <Text style={styles.paraContentStyle}>{paragraph2}</Text>
                <Text style={styles.paraContentStyle}>{paragraph3}</Text>
                <Text style={styles.paraContentStyle}>{paragraph4}</Text>
                <Text style={styles.paraContentStyle}>{paragraph5}</Text>
                <Text style={styles.paraContentStyle}>{paragraph6}</Text>
                <Text style={styles.paraContentStyle}>{paragraph7}</Text>
                <Text style={styles.paraContentStyle}>{paragraph8}</Text>
                <Text style={styles.paraContentStyle}>{paragraph9}</Text>
                <Text style={styles.paraContentStyle}>{paragraph10}</Text>
                <Text style={styles.paraContentStyle}>{paragraph11}</Text>
                <Text style={styles.paraContentStyle}>{paragraph12}</Text>
            </ScrollView>
            <View style={styles.iconsViewStyle}>
                ...
                <TouchableOpacity>
                    <Entypo name={heart} size={25} style={styles.iconStyle} />
                </TouchableOpacity>
            </View>
        </View>
    );
